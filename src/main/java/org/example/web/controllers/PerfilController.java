...
public class PerfilController {
    ...
    public String showProfile(Model model) {
        ...
        return "app/perfil"; // Plantilla: resources/templates/app/perfil.peb.html
    }
    ...
    public String updateProfile(@Valid @ModelAttribute("usuario") User updatedUser,
        ...
        if (bindingResult.hasErrors()) {
            model.addAttribute("mensaje", "Error al actualizar el perfil.");
            return "app/perfil";
        }
        ...
        if (existingUser != null) {
            ...
            // No permitimos cambiar username o rol aquí por seguridad
        }
