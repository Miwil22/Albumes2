...
public interface AlbumRepository extends JpaRepository<Album, Long>, JpaSpecificationExecutor<Album> {
    ...
    // Buscar por título (Equivalente funcional a buscar por número de tarjeta en tu dominio)
    Optional<Album> findByTituloEqualsIgnoreCase(String titulo);

    // Actualizar el album con isDeleted a true
    ...
    // Consulta por ID de Usuario (a través del Artista)
    ...
    // Obtiene si existe un album con el id del usuario (a través del Artista)
    ...
    // Alternativa por ID (también útil para GraphQL)
