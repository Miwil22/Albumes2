...
public class UsersRestController {
  ...
  public ResponseEntity<PageResponse<AlbumResponseDto>> getAlbumesByUsuario(
    ...
    log.info("Obteniendo albumes del usuario con id: {}", user.getId());
  ...
  /**
   * Obtiene un album del usuario actual
   *
   * @param user     usuario autenticado
   * @param idAlbum id del album
   * @return Album
   * @throws AlbumNotFoundException si no existe el album
   */
  ...
  public ResponseEntity<AlbumResponseDto> updateAlbum(
    ...
    log.info("Actualizando album con id: {}", idAlbum);
